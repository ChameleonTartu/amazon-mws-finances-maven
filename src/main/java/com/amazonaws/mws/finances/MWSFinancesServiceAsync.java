...
public interface MWSFinancesServiceAsync extends MWSFinancesService {
     ...
     * @return {@code Future<ListFinancialEventGroupsResponse>} response.
     */
     ...
     * @return {@code Future<ListFinancialEventGroupsByNextTokenResponse>} response.
     */
     ...
     * @return {@code Future<ListFinancialEventsResponse>} response.
     */
     ...
     * @return {@code Future<ListFinancialEventsByNextTokenResponse>} response.
     */
